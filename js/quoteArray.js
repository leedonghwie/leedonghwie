const quoteArray = [
    ...
    {
        text:"안녕하세요. 몰름보입니다. 오늘은 4월 24일 5시입니다. 반갑습니다. 드디어 원고 작업이 끝났습니다. 내가 4월을 이겼다. 4월을 이겼다. 고맙습니다. 원고 작업이 3개가 있었는데 4월 내내 그거를 처리했고 방금 마지막 원고를 송고를 했습니다. 아무것도 안 해본 건데 힘들었어요. 안 힘든 원고라기보다 아무도 안 볼 것 같은 느낌의 원고인데 하여간 잘 끝냈습니다. 글 쓰는 동안 녹음을 하고 싶었는데 정신이 없어서 정신이 없다고 생각해서 녹음을 안 하고 있었거든요. 그래서 이렇게 끝나자마자 녹음을 하게 됐습니다. 그래서 4월에 새로운 직장에서 출발도 순조롭게, 제 생각에만 순조로울 수 있지만, 일단은 순조롭게 하고, 해야 하는 개인적인 일들도 끝내고 결혼식도 하나 가고 집들이도 하나 가고 병원도 잘 다니고 운동만 안 가고 밥 잘 챙겨 먹고 잘 했습니다. 그 기쁜 소식을 전하려고 노트북 앞에 앉아 있습니다. 그래서 원고 작업이 끝난 기념으로 라면 끓여 먹었어요. 윤여정 배우가 오스카 끝나고 라면 먹었다고 하는데 그에 비하면 하찮은 일이지만 하여간 큰일을 맞춰서 라면을 끓여 먹었습니다. 기쁩니다. 기뻐요 홀가분합니다. 그래서 지금 넷플릭스 보고 있었어요. 넷플릭스에서 「외교관」이라는 드라마를 시작한 차였습니다. 진짜 외교관들이 이렇게 급박하게 일하나 하는 생각이 들었어요. 뭐 하여간에 잘 끝났습니다. 하나하나 공개가 될 거예요. 두 개는 웹에서 볼 수 있고 하나는 종이로 출판이 될 예정입니다. 그거 말곤 아무것도 없어요. 다른 아무것도 소식이 없습니다. 몰름보였습니다. 농담입니다.",
        title:"4.24(탈고)",
    ...
    {
        text:"쓴 글 이야기를 해볼까요. 제가 스튜디오에도 올렸듯이 지난 4월 말에 서울 시립미술관에서 운영하는 미술 연구 플랫폼 세마 코랄에 어려움에 대하여라는 글을 올렸습니다. 약 1만 자 정도 되는 분량의 글이고 맨 처음에 청탁을 받았을 때는 게임과 미술에 대해서 이야기를 해달라고 했는데 제가 한동안 생각을 해보았는데 미술에 대해서 할 수 있는 말이 저에게 없더라고요 그래서 어차피 청탁서에서도 이제 조금 제가 주제를 선택할 수 있는 여지를 남겨주셨으니까 조금 많이 틀어서 내 이야기를 좀 해봐야겠다. 이렇게 결심을 하고 키워드를 잡아서 저의 생각을 펼치는 글을 썼습니다. 어려움이라는 키워드는 저에게 항상 가까이 있었어요. 많은 것이 어려우니까 저는 많은 것을 어려워하는 편입니다. 무언가가 어렵다는 것을 잘 못 놔둬요 그리고 어렵다는 것을 방치를 잘 못하고 그냥 그대로 받아들이지를 잘 못합니다. 저에게 그만큼 중요한 키워드였던 거죠. 어려움이라는 건 그래서 키워드를 잡고 나니까 글을 구조를 짜는 거는 금방 짰어요. 금방 짰고 세부적으로는 많이 다듬어야 했지만 그렇습니다.",
        title:"5.5",
        link:"https://steadio.co/creator/mollumbo/posts/e29f4c3a-82e1-460b-9d72-7e298e55f503",
    },
    {
    ...
    {
        text:"제가 원래 나랏일 하는 백인 여자가 나오는 드라마를 굉장히 좋아합니다. 홈랜드가 대표적이고 최근에 나온 [외교관]도 그런 드라마죠. 그리고 영화로는 [제로 다크 서티] 제시카 차스테인이 나와서 빈라덴 잡는 [제로다크서티]도 좋아하고 [시카리오]도 좋아합니다. [시카리오]에는 에밀리 블런트가 FBI 에이전트로 나오죠.",
        title:"5.13 (맥주)",
        link:"https://steadio.co/creator/mollumbo/posts/7af9dfc1-6c52-47d9-b6bb-a658d91d6931",
    },
    {
    ...
    {
        text:"어떤 외국어는 읽을 수가 없어요. 모든 외국어가 읽을 수 없다는 말이 아니라 어떤 외국어는 읽을 수가 없어요. 이거는 100% 맞을 수밖에 없는 말이에요. 어떤 외국어는 읽을 수가 없다. 어떤 외국어는 읽을 수가 없습니다. 외국어랑 그런 존재죠. 어떤 외국어는 읽을 수가 없습니다. 모든 외국어를 읽을 수가 없다고 말하는 게 아니라, 어떤 외국어는 언제까지나 나에게 외국어로 남아있을 수밖에 없다는 것이죠. 그런데 어떤 외국어를 읽을 수 없다는 사실이 때로는 우리 인생을 피곤하게 합니다. 어떤 외국어를 읽을 수가 없는 건 되게 자연스러운 일이거든요. 누구나 읽을 수 없는 외국어가 있어요. 누구에게나 읽을 수 없는 외국어가 있죠. 그런데 내가 읽을 수 없는 외국어가 있다는 사실이 나를 설웁게 만들 때가 있죠. 압박을 느끼게 만들기도 하고요. '너는 이것을 읽을 수 있어야만 해' 이렇게 명령하기도 합니다. 어떤 외국어는 언제까지나 외국어로 남아있어요. 내가 무관심해서일 수도 있고 그것이 어려워서일 수도 있죠.",
        title:"5.20(말이 빠른 일기)",
        link:"https://steadio.co/creator/mollumbo/posts/0eed2a71-403a-4348-9848-e63c4fc9e869",
    },
    {
    ...
    {
        text:"근데 얼마 전에 비행기 사고 있었잖아요 착륙 중인 비행기 비행기가 지상에서 200미터 정도 떠 있을 때 한 승객이 저랑 나이가 비슷하던데 비상문을 열어버려가지고 다행히 인명피해는 없었습니다. 왜 그랬냐고 물으니까 빨리 내리고 싶었다고 말했다고 해요. 무서운 사건입니다. 인명피해가 없어서 다행이지 너무나 무서웠을 것 같아요. 비행기와 밀폐되어 있으니까 교통수단이 되지 밀폐가 안 되어 있으면 그걸 어떻게 타고 다니겠어요 무서워가지고 매번 스카이다이빙 하는 것 같을 것 같아. 그 밀폐를 깨버린 거잖아요. 상공에서 비행기 문을 열었다고 밀폐되어야 하는 것이 밀폐되지 않았을 때 문제가 생깁니다.  김치통 같은 거요 비닐봉지 가방 호흡기 파스 데일 밴드 밀폐되어야 하는 것이 밀폐되지 않으면 문제가 생깁니다. 무언가가 통과되지 말아야 할 때 통과되도록 뚫려 있으면 문제가 생기죠. 상공의 비행기 너무 무서웠을 것 같아. 나한테도 기절했을 것 같아. 사람들이 호흡 곤란을 호소했대요. 착륙하고 나서 그 사람은 구속됐다고 해요. 항공보안법 위반으로 구속되었다고 합니다. 참 별일이 다 있죠 뉴스를 잘 보지 않는데 제 시선을 끈 뉴스였습니다.",
        title:"5.29 (감기)",
        link:"https://steadio.co/creator/mollumbo/posts/9d09c4a4-3a76-4f49-aff0-430922698d04",
    },
    {
        text:"오늘은 예고를 했다시피 질문을 많이 달아주셨는데 그 질문들에 대한 답을 해보려고 합니다. 질문은 총 질문이 아니라 질문과 인사까지 합쳐서 17개가 들어왔고요. 제가 무작위는 아니고 대답하기 어려워 보이는 질문들을 먼저 하고 그다음에 차차 쉬운 질문으로 넘어가는 순서로 하려고 합니다. 시작해 볼까요 시작해 보겠습니다.",
        title:"6.11 (Q&A)",
        link:"https://steadio.co/creator/mollumbo/posts/f95647f4-de64-4186-93da-14d55505d8f5",
    },
    {
    ...
    {
        text:"오늘 진행한 『게임:행위성의 예술』 북토크 음성 파일 및 발표자료 전문을 공개합니다. 무더운 날씨에 와주신 분들, 함께 수고해 주신 전대한 님 , 초대해 주신 YPC 모두모두 감사드립니다. 이미지 사용시 저작권 표시를 꼭 해 주세요.",
        title:"(audio&PPT) 7.1 『게임:행위성의 예술』 북토크",
        link:"https://steadio.co/creator/mollumbo/posts/999c7e29-801b-48d0-8c6f-687bf04e7d3c",
    },
    {
        text:"책 만드는 일은 사람들을 불러 모으는 일과 비슷합니다. 책 만드는 일은 사람들에게 손을 내미는 일이에요. 혼자서 고고하게 버티고 서서는 책 만들기가 필요하지 않습니다. 책을 만드는 거는 사람들에게 손을 내미는 일입니다. 내가 그 종이 일을 뭉쳐서 쌓아놓을 테니 쌓아 놓는다는 건 철 한다는 거예요. 글이 적힌 종이를 처리해 놓을 테니 관심을 가져주세요 하는 것입니다. 관심을 애타게 요청합니다. 애타게 관심을 요청합니다. 에타에 관심을 기다립니다. 요새 많이 느끼는 감정 중에 하나가 외로움인데요 외로움을 많이 느낍니다. 어떤 종류의 외로움 사적인 영역에서 느끼는 외로움은 아니고 어떤 공적 영역에서의 외로움을 많이 느끼는 것 같습니다. 사람들이 나에게 손을 많이 뻗어주면 좋겠다 이렇게 자주 생각합니다. 불안함도 많이 느낍니다. 이렇게 혼자인 것 같은 느낌이 지속될 것 같은 느낌입니다. 불안가요 이러고 외롭지 않고 불안하지 않다면 지금보다 훨씬 행복하게 지낼 수 있을 것 같은데 불안과 외로움에 휩싸일 때가 자주 있어요. 아마 다들 그렇겠죠 아마 다들 그럴 것 같습니다. 여러분은 불안과 외로움에 또 왜 싸우시나요? 글쓰기는 제가 불안과 외로움에 싸우는 수단인 것 같아요. 제가 가지고 있는 몇 안 되는 수단 예술 그리고 예술에 대해 말하는 것은 외로움과 불안과의 싸움 싸움도 투쟁 도구인 것 같습니다. 투쟁할 수 있는 도구가 그렇게 많지 않아요. 하지만 그렇게 투쟁하지 않으면 아마 침몰해버릴 거예요. 막 비정하게 말하는 건 아니고 사람은 몇 개 가지 몇 가지 상황만 되면 침몰해 버릴 수도 있는 존재니까요. 외로움과 불안이 사람을 침몰시킬 수 있다고 생각합니다. 외로움과 불안이 사람을 침몰시킬 수 있다고 생각해요. 사람이 살아가는데 다른 사람의 손길을 간절히 원한다는 게 우습게 느껴질 때도 있지만 그거는 무서운 운명인 것 같습니다.",
        title:"8.7(오밤중)",
        link:"https://steadio.co/creator/mollumbo/posts/10f42284-0793-4008-8f9b-29ce571e6b8b",
    },
    {
        text:"제가 가지고 있는 욕망 중 가장 큰 것 중 하나가 말에 대한 욕망인 것 같다는 생각을 요즘 합니다. (동물로서의 욕망 이외에 다른 욕망을 가지고 있다는 건 좋은 일입니다.) 말에 대한 욕망, 더 정확히는 '그럴 듯한 말'에 대한 욕망입니다. 그럴 듯한 말과 글을 내놓고 싶어합니다. 찌를 수 있고 막을 수 있고 맺을 수 있는, 송곳 같고 통나무 같고 매듭 같은 말에 대한 욕망이 있습니다. 얼마 전에는 그런 글을 읽었습니다. 질투가 날 수 있으니 인용은 하지 않습니다. 하여간 말에 대한 욕망이 있습니다. 좋은 글을 쓰고 좋은 대화를 할 수 있으면 좋겠습니다. 욕망에 시달리기보다 욕망에 대해 생각할 수 있다면 오늘은 정신이 건강한 편입니다.",
        title:"9.2 (글로 쓰는 음성일기)",
        link:"https://steadio.co/creator/mollumbo/posts/6d999275-d03f-4583-a6da-08c9cae4fea5",
    },
    {
    ...
    {
        text:"평소에 많은 사람들을 생각합니다. 과거의 사람들을 생각합니다. 그들을 생각하는 일은 즐겁지 않습니다. 즐겁지 않은 생각을 많이 합니다. 저는 기억력이 좋지 않은데, 그나마 떠오르는 것들은 별로 좋은 기억들이 아닙니다. 좋은 기억들은 쉽게 휘발됩니다. 인생의 많은 문제들이 여기서 비롯된다고 저는 생각합니다. 내가 내 편이면 좋겠다고 생각합니다. 내가 내 편이 아닐 때 정말 피곤한 하루가 흘러갑니다. 내가 내 편이 아닐 때 나는 아무의 편도 될 수가 없습니다. 내가 내 편이 아닐 때 나는 거짓말을 일삼습니다. 내가 내 편이 아닐 때 나는 나 자신과 시시때때로 싸우게 됩니다. 그 싸움에서는 항상 내가 집니다. (오 쫌 철학적인데)",
        title:"9.29",
        link:"https://steadio.co/creator-studio/posts/write?postUuid=ba4295b5-3f35-4d34-806e-2412bece5a02",
    },
    {
        text:"요새는 영화를 많이 보았습니다. 오늘은 박찬욱의 [올드보이]를 보았고 어제는 넷플릭스에서 새로 올라온 [렙타일]이라는 미국의 수사 스릴러를 범죄 스릴러를 보았습니다. 둘 다 아주 재밌게 보았는데요. [올드보이]는 모두들 잘 아시다시피 20년 된 유명한 작품이죠. 이번에 다시 영화를 보니까 문득 강혜정 배우가 굉장한 역할을 여기서 하고 있다는 생각이 들었습니다. 물론 이것도 잘 알고 계시겠지만요. 그냥 최민식과 유지태라는 고래 싸움에 새우등 터지는 사람처럼 이렇게 인식이 되곤 했는데 강혜정 배우가 굉장한 연기력 그리고 존재감을 뽐내고 있다는 생각을 했습니다. 그런데 커리어가 안타깝게 잘 되지 않았죠. 뭐 제가 안타까워할 일은 아니지만 또 다른 작품이 나오면 좋겠다고 문득 생각을 했습니다.",
        title:"10.1",
        link:"https://steadio.co/creator/mollumbo/posts/601ad7e2-0e6c-4b4a-8d8b-52a0f9cbeaec",
    },
    {
        text:"얼마 전에는 글을 하나 썼습니다. 어딘가에 그냥 누가 써달라고 한 글은 아니고 그냥 혼자서 쓰고 싶어서 썼어요. 네 누가 써달라고 한 글은 아니고 혼자서 썼어요. 뭐 하반기가 되어서는 누가 글 써달라고 하는 적이 별로 없습니다. 그리고 글을 맺어보려고 오랫동안 노력을 했는데 오랜만에 글을 하나 맺었어요. 그래서 굉장히 혼자서는 어떤 슬럼프 같은 것을 끊어내지 않았나 하는 생각에 기뻤습니다. 글을 쓰는 과정은 과정 자체는 물론 어려웠지만 할 만했는데 이제 동료들에게 읽히면서 비판을 많이 받았어요. 그래서 그 비판을 소화하는 데 많은 애를 먹었습니다. 글을 처음 써보고 글모임이 있어서 가져갔을 때 많은 비판을 받고 글을 고쳐야 했어요. 그래서 그거를 많은 노력을 해서 고쳤고 또 글모임 동료에게 보여줬을 때 비슷한 비판에 직면을 해서 그 점이 좀 이번 글을 쓰는 데 가장 이렇게 기억에 남는 기억에 남는다고 그래야 되나 이렇게 가장 저에게 결정적인 순간이었습니다. 비판을 받고 어느 것은 제가 수용을 했고 어느 것은 수용하지 않았어요. 제가 읽어달라고 해서 동료가 많이 힘들어했는데 왜냐하면 전혀 동의가 되지 않는 글을 계속 가져오니까 힘들어 했는데 그래서 뭔가 최대한 비판을 수용하려고 노력을 했지만 최종적인 순간에 가서는 제가 받아들이지 안 왔습니다. 이거는 뭐 글쎄요 이론적인 글쓰기를 하다 보면 일어날 수 있는 부분인 것 같아요. 이제 이제 찬반이 있는 글이다 보니까 반대에 직면할 수가 있게 되는 거죠. 그래서 반대에 직면했을 때 제가 어떤 태도를 보이는지 당황을 하는지 의연한지 이런 것도 드러나는 순간이고 하여간 반대에 직면을 한 경험이 이번에는 강하게 남았습니다. 어떤 개념에 대해서 논쟁을 한 건데요. 문제가 된 개념은 이론이라는 개념이었습니다. 이론이 무엇이냐를 결정함에 있어서 차이가 있었던 거죠. 근데 저의 경우에는 차이가 있구나 차이를 확인했다 정도로 생각을 했는데 동료 입장에서는 차이가 있을 수 없는 것에 차이가 있다고 주장하는 저를 받아들이기가 힘들어 하는 것 같았습니다. 그래서 좀 마음이 안 좋았어요. 이번 글쓰기에서는 그런 그런 순간이 있었네요. 아마 동료분도 이것을 들을 수도 있는데 이렇게 언급을 하는 것을 별로 안 좋아하실 것 같아서 일단은 여기까지 하겠습니다. 글을 썼다. 그게 최근에 가장 큰 저에게 일어난 사건이다. 그런 말입니다.",
        title:"10.22",
        link:"https://steadio.co/creator/mollumbo/posts/c083ef57-a3d9-4a30-af95-df454e1a28c7",
    },
    {
